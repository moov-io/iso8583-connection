...
We recommend using additional git remote's for pushing/pulling code. Go cares about where the `iso8583-connection` project lives relative to `GOPATH`.

To pull our source code run:

```
$ go get github.com/moov-io/iso8583-connection
```

Then, add your (or another user's) fork.

```
$ cd $GOPATH/src/github.com/moov-io/iso8583-connection

$ git remote add $user git@github.com:$user/iso8583-connection.git
